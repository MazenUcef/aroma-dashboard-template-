...
const ColumnChart: React.FC<DashboardCardProps> = ({
        ...
        xaxis: {
          ...
          labels: {
            style: {
              fontFamily: "Inter, sans-serif",
              cssClass:
                "text-xs font-normal fill-foreground dark:fill-foreground",
            },
          },
          axisBorder: {
            show: false,
  ...
  return (
    <div className="w-full md:w-[46.5rem] h-full bg-background rounded-lg p-4 md:p-6 text-foreground dark:text-foreground">
      <div className="w-full flex justify-between items-center mb-4">
        ...
        <div className="font-semibold">
          <button
            ...
            className={`w-[5.063rem] rounded-l-md border border-customborder h-[2.375rem] cursor-pointer ${
              activeTab === "yearly" ? "bg-customtab" : ""
            }`}
          >
            Years
          </button>
          <button
            ...
            className={`w-[5.063rem] border border-customborder h-[2.375rem] cursor-pointer ${
              activeTab === "monthly" ? "bg-customtab" : ""
            }`}
          >
            Months
          </button>
          ...
          <button
            ...
            className={`w-[5.063rem] rounded-r-md border border-customborder h-[2.375rem] cursor-pointer ${
              activeTab === "daily" ? "bg-customtab" : ""
            }`}
          >
            Daily
          </button>
