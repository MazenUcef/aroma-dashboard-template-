      ...
      <div>
        <form className="flex flex-col gap-[24px]">
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-[33rem] flex justify-between items-center h-[3.5rem] rounded-lg bg-forminputs py-[8px] px-[16px]">
          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="w-full md:w-[33rem] h-[3.5rem]">
              <label
