...
const LowStockComp = ({ list }: LowStockCompProps) => {
  return (
    <div className="w-full md:w-[22.5rem] flex flex-col p-3 h-full bg-background text-foreground dark:text-foreground rounded-lg mt-6">
      <div>
      ...
      <div>
        <button className="w-full md:w-[20.5rem] h-[3rem] flex items-center justify-center gap-2 font-semibold  rounded-lg text-xs text-white bg-[#244937] hover:bg-green-800 cursor-pointer">
          View Inventory
          <ArrowRight />
        </button>
      </div>
