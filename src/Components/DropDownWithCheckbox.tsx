...
export const DropdownMenu: React.FC<DropdownMenuProps> = ({
    ...
    return (
        <div className={`relative w-[24px] h-[24px] inline-block ${className}`} ref={dropdownRef}>
            <button
            ...
            {isOpen && (
                <div
                    className={`z-10 absolute ${position === 'right' ? 'right-0' : 'left-[-170px]'} top-[-70px] mt-1 bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44 dark:bg-gray-700 dark:divide-gray-600 ${menuClassName}`}
                >
                    <ul
